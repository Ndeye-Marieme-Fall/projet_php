...
<body>
<header>
    <h2> Rechercher un bien pour un achat</h2>
    <nav>
    ...
    <h2>biens disponibles</h2>
           ...
           <img src="img_video/téléchargement (3).jpeg" alt="maison moderne" heigth="200" width="300">
            <div>
                ...
                <a href="exercice15(2).php">
                    <button onclick="alert ('plus dínfos sur ce bien')">Louer</button>
                </a>
                </div>
            </div>
            <div class="property-item">
            ...
            <div>
                ...
                <a href="exercice15(2).php"> 
                    <button onclik="alert('plus d'infos sur ce bien')">Louer</button>
                </a>
            </div>
        </div>
        <div class="property-item">
        ...
        <div>
            ...
            <a href="exercice15(2).php">
                <button onclick="alert('Plus d\'infos sur ce bien')">Louer</button>
            </a>
        </div>
    </div>
